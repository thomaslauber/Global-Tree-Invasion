...
fdmet.inv <- readRDS("data/FDmetrics_Allspecies.rds") %>%                                                    # Read all functional data
...
fdmet.nat <- readRDS("data/FDmetrics_Nativespecies.rds") %>%                                                 # Read native functional data
...
fdmet.env.comp <- fdmet %>%     # Start with fdmet                                  
...
write.csv(dat.final.analyses, "data/GFBI_invasion_FDforanalyses.csv")
saveRDS(dat.final.analyses, "data/GFBI_invasion_FDforanalyses.rds")