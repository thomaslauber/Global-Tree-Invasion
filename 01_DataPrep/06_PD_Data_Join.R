...
pc <- readRDS("data/GFBI_na_inv_prop_counts.rds")                                                                      # Read prop/counts/ba invasive data 
...
pdmet.inv <- readRDS("data/PDmetrics_Allspecies.rds") %>%                                               # Read all phy data
...
pdmet.nat <- readRDS("data/PDmetrics_Nativespecies.rds") %>%                                                  # Read native phy data
...
pdmet.env.comp <- pdmet %>%     # Start with pdmet                                  
...
write.csv(dat.final.analyses, "data/GFBI_invasion_PDforanalyses.csv")
saveRDS(dat.final.analyses, "data/GFBI_invasion_PDforanalyses.rds")