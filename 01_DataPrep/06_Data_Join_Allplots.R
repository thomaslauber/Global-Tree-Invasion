...
met.env.comp <- pc %>%     # Start with pc                                  
  ...
  mutate_at(c("nativect", "invasct", "propinvasive", "sprich", "nativeba", "invba", "pinvba",       
...
dat <- met.env.comp %>%                                                                                      # Start fdmet.env.comp
...
met.env.comp.simp <-  met.env.comp %>%                                                                       # Start fdmet.env.comp
...
write.csv(dat.final.analyses, "data/GFBI_invasion_foranalyses_allplots.csv")
saveRDS(dat.final.analyses, "data/GFBI_invasion_foranalyses_allplots.rds")