...
dat <- readRDS("data/GFBI_invasion_intactPDforanalyses.rds")
...
saveRDS(dat.stat.mod.noscale,"data/Intact_PDRACdf_noscale_global_dat.stat.mod.rds")
...
dat.prop.mod.noscale <- dat.prop.mod.noscale %>%
  mutate(MAT = MAT/10, MAP = MAP/10)
saveRDS(dat.prop.mod.noscale,"data/Intact_PDRACdf_noscale_global_dat.prop.mod.rds")
...
dat.prop.modb.noscale <- dat.prop.modb.noscale %>%
  mutate(MAT = MAT/10, MAP = MAP/10)
saveRDS(dat.prop.modb.noscale,"data/Intact_PDRACdf_noscale_global_dat.prop.modb.rds")
